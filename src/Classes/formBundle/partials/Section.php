...
class Section {
    ...
    function appendRow(string|null $each_cell_default_class = 'col-xxl-3 col-lg-4 col-md-6 mb-2'): Row
    {
    ...
    function prependRow(string $each_cell_default_class = 'col-xxl-3 col-lg-4 col-md-6 mb-2'): Row
    {
        $newRow = new Row($each_cell_default_class);
